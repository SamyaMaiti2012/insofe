...
setwd("/Users/samyam/Documents/Samya/Insofe/insofe/day18/20190203_Batch56_CSE_7305c_Lab04_RecommendationSystems")
```
...
{
  dist[i] = euclid(data1[x,],as.vector(data1[i,])) # find the euclidean distance for the row to every other row in the dataset
  user[i] = i
}
